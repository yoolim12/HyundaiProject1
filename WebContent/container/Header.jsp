...
<body>
    ...
    <div class="loginbtn">      
       <div>
         <button class="custom-btn btn-1" type="button" onclick="location.href='sub?command=MemberJoin';">회원가입</button> 
         <button class="custom-btn btn-1" type="button" onclick="location.href='sub?command=Login';">로그인</button>
         <button class="custom-btn btn-1" type="button" onclick="location.href='sub?command=AdminLogin';">관리자 로그인</button>
      </div>
   </div>
       <div class="cont_center">
       
        <h1 class="logo"><a href="index.jsp"><!-- <img class="logo" src="./image/logo.png"/>--></a></h1>
        
        <nav class="gnb_area">
            <ul class="gnb">
                <li>    
                    <a class="main_menu" href="">회사소개</a>
