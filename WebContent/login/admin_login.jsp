...
<body>
	<div class="container">
		<form method="post" action="admin_login1">
			<table class="table table-bordered table-hover" style="text-align: center; border:1px solid #dddddd">
				...
				<tbody>
					<tr>
						...
						<td colspan="2"><input class="form-control" type="text" id="masterID" name="masterID" maxLength="20"></td>
					...
					<tr>
						...
						<td colspan="2"><input class="form-control" type="password" id="masterPassword1" name="masterPassword1" maxLength="20"></td>
					</tr>
