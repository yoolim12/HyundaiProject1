...
if (session_id == null){ //session값이 없으면 로그인 해제 시켜주고 메인페이지로 이동
...
%>
<% if(session_id == null) { // 작성자 : 신동근, 헤더파일 삽입 하기위한 코드
%>
...
<body>
	...
	<div class="wrap wrap_main">
		...
		<script>
           ...
           //const test = document.querySelectorAll(':hover');
           //console.log('hovertest: ', test);
           ...
           window.addEventListener("scroll", () => {
              if (window.scrollY > 0) {
                 ...
                 //logoImg.src = "./image/logo_main_top.png";
